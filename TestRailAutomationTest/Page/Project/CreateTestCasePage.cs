...
public class CreateTestCasePage : BasePage
{
    ...
    private static readonly By AddTestCaseButton = By.XPath("//div[@id=\"custom_steps_separated_container\"]//a[@class=\"addStep\"]");
    private static readonly By StepDescriptionInputLocation = By.XPath("//td[@class=\"step-content\"]//div[@placeholder=\"Step Description\"]");
    private static readonly By StepExpectedResultInputLocation = By.XPath("//td[@class=\"step-content\"]//div[@placeholder=\"Expected Result\"]");
    ...
    public void FillTestCaseForm(BaseTestCase testCase)
    {
        ...
        FillInputAfterClick(GetElementLocation(CommonInputLocation,TestCaseProperties.Estimate), testCase.Estimate.ToString());
        FillInputAfterClick(GetElementLocation(CommonInputLocation,TestCaseProperties.References), testCase.References);
        ChoosePropertyValue(TestCaseProperties.AutomationType, testCase.AutomationType);
    ...
    private void FillDescription(BaseTestCase testCase)
    {
        ...
        switch (testCase.Template)
        {
            ...
            case TestCaseData.StepsTemplate:
                FillInputAfterClick(GetElementLocation(CommonDescriptionInputLocation,TestCaseProperties.Preconditions), 
            ...
            case TestCaseData.TextTemplate:
                ...
                FillInputAfterClick(GetElementLocation(CommonDescriptionInputLocation,TestCaseProperties.ExpectedResult), 
