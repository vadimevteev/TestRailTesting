...
namespace TestRailAutomationTest.Page.TestCase.CreateTestCasePage.Section
{
    public class TextSection
    {
        ...
        private Textarea PreconditionsArea => new(_driver,
            SearchStrategy.TextareaXpath(TestCaseProperties.Preconditions),
        ...
        private Textarea ExpectedResultArea => new(_driver,
            SearchStrategy.TextareaXpath(TestCaseProperties.ExpectedResult),
